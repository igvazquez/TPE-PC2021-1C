...
parse_args(const int argc,const char **argv) {
    args = (struct httpdargs*) calloc(1, sizeof(struct httpdargs)); // sobre todo para setear en null los punteros de users

    args->httpd_addr = "0.0.0.0";
    args->httpd_port = DEFAULT_PORT;
